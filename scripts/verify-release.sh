...
usage() {
	...
	Options:
	  ...
	  --offline          verify attestations from the bundled .jsonl assets
	                     instead of the GitHub API (still needs Sigstore's
	                     trusted root unless GH_TRUSTED_ROOT points at one)
